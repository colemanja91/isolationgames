...
class CognitoClient
  def initialize(params = {})
    @pool_id = Rails.application.credentials.cognito[:pool_id]
    @client_id = Rails.application.credentials.cognito[:app_client_id]
    @client_secret = Rails.application.credentials.cognito[:app_client_secret]
